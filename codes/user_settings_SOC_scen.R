...
GLOBIOM.file <- "inputs/output_3482_merged.gdx" # set location of the accelerator merge file!!!
# -------------------------
# Configuration / args
# -------------------------
...
if (length(args) >= 3) {
  ...
  scen.filter <- c("Crop_SOC150", "Grass_SOC150", "Agri_SOC150", "BASE")
}

rename.model <- "GLOBIOM_SOC"
